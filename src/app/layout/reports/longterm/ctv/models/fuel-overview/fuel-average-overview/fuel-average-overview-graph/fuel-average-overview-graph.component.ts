...
@Component({
  selector: 'app-fuel-average-overview-graph',
  templateUrl: './fuel-average-overview-graph.component.html',
  styleUrls: ['../fuel-average-overview.component.scss']
})
export class FuelAverageOverviewGraphComponent implements OnChanges {
