...
export class WeatherForecastComponent {
  constructor(private weatherForecastService: WeatherForecastUtilsService, private weatherForecastCommunicationService: WeatherForecastCommunicationService,private modalService: NgbModal) { }
