...
import { GateAccessPickerComponent } from './gate-access-picker.component';

describe('HeadingPickerComponent', () => {
  let component: GateAccessPickerComponent;
  let fixture: ComponentFixture<GateAccessPickerComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GateAccessPickerComponent);
